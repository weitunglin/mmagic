...
from mmagic.registry import MODELS as MODELS_MMAGIC
...
selective_scan_flop_jit: Callable = build.seamamba.selective_scan_flop_jit
flops_selective_scan_fn: Callable = build.seamamba.flops_selective_scan_fn
verbose = False
